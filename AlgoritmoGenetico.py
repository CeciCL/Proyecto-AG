...
print('Hola,bienvenido a mi algoritmo génetico,aquí vamos a ver el problema de 0 coliciones esntre reinas en un tablero de ajedréz.\n'
      'Lo primero que vamos a hacer es crear nuestra poblacion,para eso voy a necesitar tu ayuda para elegir el número de individuos que va a tener la población,el cual tiene que ser un número par.')
...
if cant%2 == 0:
    ...
    for i in range(50):
        ...
        #Numero de mejores individuos por generacion
        fitness_poblacion=[]
        ...
        #Numero de peores individuos por generación
